...
## Execution Workflow
1. **Data Fetching:** Call `github-trending-mcp:get_trending` and `get_repo_details` to obtain raw data.
...
3. **Format & Publish:** Apply HTML table layout specified in [SKILL.md](skills/github-trending-newsletter-compiler/SKILL.md) and save to `reports/YYYY_MM/`.
